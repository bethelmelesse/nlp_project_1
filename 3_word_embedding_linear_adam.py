'''WORD EMBEDDING LINEAR REGRESSION USING ADAM 1'''
...
class LinearRegressionModel(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.linear = torch.nn.Linear(50, 1, bias=True)               # two in and one out
...
optimizer = torch.optim.Adam(our_model.parameters(), lr = 0.01)     # select the optimizer
...
def test():
    ...
    with torch.no_grad():
        ...
        print(pred_y[1], pred_y[1027])                # (2000, 1)    ------> (2000)
