'''WORD EMBEDDING LINEAR REGRESSION USING SGD 1'''
...
class LinearRegressionModel(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.linear = torch.nn.Linear(50, 1, bias=True)               # input_dim=50 and Output_dim=1
...
the_loss = torch.nn.MSELoss()                                       # the loss
optimizer = torch.optim.SGD(our_model.parameters(), lr = 0.01)     # optimizer
